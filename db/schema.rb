...
ActiveRecord::Schema.define(version: 20140222114509) do
  ...
  create_table "orders", force: true do |t|
    ...
    t.datetime "updated_at"
    t.boolean  "paid"
    t.integer  "total_pennies",  default: 0,     null: false
    t.string   "total_currency", default: "GBP", null: false
  end
  ...
  create_table "users", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "receive_due_orders_emails", default: true
  end
